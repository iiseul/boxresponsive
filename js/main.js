// page 로드 이벤트
window.addEventListener("load", () => { //window 즉, browser에 이벤트 연결
    //이 이벤트문은, 이미지소스까지 모든 로딩이 완료되어야  안쪽 코드를 실행한다
    //플러그인 사이트 자체에서 아래구조를 붙이기한뒤 필요한 값만 수정해서 사용하라고 제시되어있다
    ...
    for (let el of btns) {
        ...
        el.addEventListener("click", e => {
            ...
            //변수 sort에 클릭한 대상 li의 자식인 a요소의 href 속성 값 저장
